...
public class BrowseAllVideo extends ListActivity {
	ArrayList<String>videoCategory=new ArrayList<String>();
	private String video_category[]={"Education","Comedy","Horror","political","Hnuman Chllisa","india","song","Education","play station"};
	private BrowseVideoAdapter video;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		video=new BrowseVideoAdapter(this,videoCategory);
		setListAdapter(video);
	}

	private static class BrowseVideoAdapter extends ArrayAdapter<String> {
		private Context mContext;
		
		private ArrayList<String> userName = new ArrayList<String>();

		public BrowseVideoAdapter(Context context, ArrayList<String> mylist) {
