...
public class Creepers extends ListActivity implements OnClickListener{
	CreeperAdapter crepeer;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.creepers);
		video=(TextView)findViewById(R.id.tv_creepers_video);
		dayPost=(TextView)findViewById(R.id.tv_creepers_Todays);
		type=(TextView)findViewById(R.id.tv_creepers_newest);
		...
		crepeer=new CreeperAdapter(this, userName);
		setListAdapter(crepeer);
		
	}
	//adapter class bind the row layout into a list.
    
	private static class CreeperAdapter extends ArrayAdapter<String> {
		private Context mContext;
		
		//private ArrayList<String> userName = new ArrayList<String>();
	    private String[] userName;
		public CreeperAdapter(Context context, String[] userName2) {
