...
public class DrunkAss extends ListActivity implements OnClickListener{
	private String userName[]={"User 1","User 2","User 3",
			"User 4","User 5","User 6"};
	DrunkAssAdapter drunk_wall;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.drunk_ass);
		video=(TextView)findViewById(R.id.tv_drunkAss_video);
		type=(TextView)findViewById(R.id.tv_drunkAss_newest);
		dayPost=(TextView)findViewById(R.id.tv_drunkAss_Todays);
		...
		drunk_wall=new DrunkAssAdapter(this, userName);
		setListAdapter(drunk_wall);
		
	}
	//adapter class bind the row layout into a list.
	private static class DrunkAssAdapter extends ArrayAdapter<String> {
		private Context mContext;
		
		//private ArrayList<String> userName = new ArrayList<String>();
        private String[] userName;
		public DrunkAssAdapter(Context context, String[] userName2) {
