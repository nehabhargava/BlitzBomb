...
public class Fail extends ListActivity implements OnClickListener{
	FailAdapter fail;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		type=(TextView)findViewById(R.id.tv_fail_newest);
		video=(TextView)findViewById(R.id.tv_fail_video);
		dayPost=(TextView)findViewById(R.id.tv_fail_Todays);
		...
		fail=new FailAdapter(this, userName);
		setListAdapter(fail);
	}
	//adapter class bind the row layout into a list.
	private static class FailAdapter extends ArrayAdapter<String> {
		private Context mContext;
		
		//private ArrayList<String> userName = new ArrayList<String>();
        private String[] userName;
		public FailAdapter(Context context, String[] userName2) {
