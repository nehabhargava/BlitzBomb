...
public class CrazyDrunk extends ListActivity implements OnClickListener{
	CrazyAdapter crazy;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.crazy_drunk);
		video=(TextView)findViewById(R.id.tv_crazyDrunk_video);
		type=(TextView)findViewById(R.id.tv_crazyDrunk_newest);
		dayPost=(TextView)findViewById(R.id.tv_crazyDrunk_Todays);
		...
		crazy=new CrazyAdapter(this, userName);
		setListAdapter(crazy);
	}
	//adapter class bind the row layout into a list.
	private static class CrazyAdapter extends ArrayAdapter<String> {
		private Context mContext;
		
		//private ArrayList<String> userName = new ArrayList<String>();
        private String[] userName;
		public CrazyAdapter(Context context, String[] userName2) {
	...
	public void onClick(View v) {
     switch (v.getId()) {
	case R.id.tv_crazyDrunk_newest:
    ...
    case R.id.tv_crazyDrunk_video:
		...
		qa.show();
		break;
    case R.id.tv_crazyDrunk_Todays:
