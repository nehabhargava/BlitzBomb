...
public class FunnyShit extends ListActivity implements OnClickListener{
	FannyAdapter fanny;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.funny_shit);
	    video=(TextView)findViewById(R.id.tv_funny_video);
		type=(TextView)findViewById(R.id.tv_funny_newest);
		dayPost=(TextView)findViewById(R.id.tv_funny_Todays);
		...
		fanny=new FannyAdapter(this, userName);
		setListAdapter(fanny);
	 }
	 //adapter class bind the row layout into a list.
	 private static class FannyAdapter extends ArrayAdapter<String> {
		private Context mContext;
		
		//private ArrayList<String> userName = new ArrayList<String>();
        private String[] userName;
		public FannyAdapter(Context context, String[] userName2) {
